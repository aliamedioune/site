...
{
    /**
     * @Route("/chambre", name="user_chambre", methods={"GET"})
     */
    public function chambre(HotelRepository $hotelRepository,RoomRepository $roomRepository): Response
    {   
       ...
       // dump($reservations);
       // die();
        return $this->render('user/chambre.html.twig', [
