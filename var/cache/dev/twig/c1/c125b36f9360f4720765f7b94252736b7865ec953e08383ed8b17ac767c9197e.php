...
class __TwigTemplate_1ee592caf737df3c10cdebcdb211c6a26e017d3df52cb0e565f6c155ebbd6ef0 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t{{ form_row(form.image) }}
                <button class=\"btn\">{{ button_label|default('Save') }}</button>
", "user/_form.html.twig", "/Applications/MAMP/htdocs/site-atypikhouse salma/templates/user/_form.html.twig");
    }
}
