...
class __TwigTemplate_571ce335552c9d3e8806c03c23a7a851a3eac3be22b70c0525d3dfee41fb9018 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
        // line 11
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 11, $this->source); })()), "surname", [], "any", false, false, false, 11), 'row');
        echo "
\t\t\t\t";
        // line 12
...
";
    ...
    {
        return array (  70 => 13,  66 => 12,  62 => 11,  58 => 10,  54 => 9,  50 => 8,  45 => 6,  43 => 1,);
    }
...
\t\t\t\t{{ form_row(form.image) }}
                <button class=\"btn\">{{ button_label|default('Save') }}</button>
", "user/_form.html.twig", "C:\\wamp64\\www\\Sites\\site-salma\\templates\\user\\_form.html.twig");
    }
}
