...
/* messages.html.twig */
class __TwigTemplate_b81e285166ef9fb7d9764e2336d6b3bd52a84e20c50ff9cf05b71918951fbe22 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["label"] => $context["flashes"]) {
            ...
            <div class=\"alert alert-success alert-dismissible\">
                ...
                <h4><i class=\"icon fa fa-check\"></i> Votre message a été bien envoyé !</h4>
                ";
                    // line 8
                    echo $context["flash"];
                    echo "
...
$context["label"], "warning"))) {
    ...
    {% for flash in flashes %}
        ...
        {% endif %}
    {% endfor %}
{% endfor %}", "messages.html.twig", "/Applications/MAMP/htdocs/site-atypikhouse salma/templates/messages.html.twig");
    }
}
